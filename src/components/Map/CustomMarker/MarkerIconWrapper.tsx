...
export interface CustomMarkerProps {
  ...
  icon?: FunctionComponent<LucideProps> | undefined;
  color: string;
  ...
  return (
    <div className="relative inline-flex p-0 m-0">
      ...
      >
        ...
        {label && (
          <span
            className="flex flex-col absolute -top-2 -right-2 border-2 border-white bg-error rounded-full h-7 w-7 text-xs items-center pt-1">
            {label}
          </span>
        )}
      </div>
